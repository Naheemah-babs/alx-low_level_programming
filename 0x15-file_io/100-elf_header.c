 ...
 * @e_entry: The address of the entry point of the ELF.
 * @e_ident: A pointer to an array that has the ELF class.
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
 ...
 * Return: 0 on success.
 *
 * Description: If the function fails or the ELF file is absent - exit code 98.
 */
